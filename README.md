...
```javascript
dsort2sh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsort2sh@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsort2sh@v0.2.2-umd/browser.js"></script>
```
